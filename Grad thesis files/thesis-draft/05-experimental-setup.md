...
The DP sweeps are run on the two most challenging MIT-BIH partitions (label skew $C = 2$ and Dirichlet $\alpha = 0.1$) and on the meaningful PTB-XL partition (Dirichlet $\alpha = 0.1$), spanning the three methods and three budgets.
